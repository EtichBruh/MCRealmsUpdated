...
namespace common.resources
{
    ...
    public class ProjectileDesc
    {
        ...
        public ProjectileDesc(XElement elem)
        {
            ...
            Accelerate = elem.Element("Accelerate") != null;
    ...
    public class ActivateEffect
    {
        ...
        public ActivateEffect(XElement elem)
        {
            ...
            if (elem.Attribute("percentage") != null)
                Percentage = float.Parse(elem.Attribute("percentage").Value);
    ...
    public class Item
    {
        ...
        public bool Uncommon { get; private set; }
        ...
        public KeyValuePair<int, float>[] StatsBoost2 { get; private set; }
        ...
        public Item(ushort type, XElement elem)
        {
            ...
            Common = elem.Element("Common") != null;

            Uncommon = elem.Element("Uncommon") != null;

            Rare = elem.Element("Rare") != null;

            Epic = elem.Element("Epic") != null;

            Legendary = elem.Element("Legendary") != null;

            Raid = elem.Element("Raid") != null;
            ...
            var stats2 = new List<KeyValuePair<int, float>>();
            foreach (XElement i in elem.Elements("ActivatePercentOnEquip"))
                stats2.Add(new KeyValuePair<int, float>(
                    int.Parse(i.Attribute("stat").Value),
                    float.Parse(i.Attribute("percentage").Value)));
            StatsBoost2 = stats2.ToArray();
    ...
    public class ObjectDesc
    {
        ...
        //public bool ExposedImmune { get; private set; }
        ...
        public ObjectDesc(ushort type, XElement elem)
        {
            ...
            //ExposedImmune = elem.Element("ExposedImmune") != null;
