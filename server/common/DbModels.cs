...
namespace common
{
    ...
    public class DbAccount : RedisObject
    {
        ...
        {
            get { return GetValue<string>("crafting"); }
            set { SetValue<string>("crafting", value); }
        }
        ...
        public int Diamonds
        {
            get { return GetValue<int>("diamond"); }
            set { SetValue<int>("diamond", value); }
        }
        public int Iron
        {
            get { return GetValue<int>("iron"); }
            set { SetValue<int>("iron", value); }
        }
        public int Gold
        {
            get { return GetValue<int>("gold"); }
            set { SetValue<int>("gold", value); }
        }
        ...
        //public int Gems
        //{
        //    get => GetValue<int>("Gems");
       //     set => SetValue("Gems", value);
        //}

        //public int TotalGems
       // {
       //    get => GetValue<int>("totalGems");
        //    set => SetValue("totalGems", value);
       // }
        ...
        public double ResuLuck
        {
            get { return GetValue<double>("resuLuck"); }
            set { SetValue<double>("resuLuck", value); }
        }
