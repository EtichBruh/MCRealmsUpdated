    ...
    namespace wServer.realm.entities
    {
        ...
        public partial class Player : Character, IContainer, IPlayer
        {
            ...
            //private readonly SV<int> _gems;
            //public int Gems
           // {
            //    get { return _gems.GetValue(); }
            //    set { _gems.SetValue(value); }
           // }
        
            //private readonly SV<int> _currentGems;
            //public int CurrentGems
           // {
            //    get { return _currentGems.GetValue(); }
            //    set { _currentGems.SetValue(value); }
            //}
        ...
        private readonly SV<int> _diamond;
        public int Diamond
        {
            get { return _diamond.GetValue(); }
            set { _diamond.SetValue(value); }
        }

        private readonly SV<int> _iron;
        public int Iron
        {
            get { return _iron.GetValue(); }
            set { _iron.SetValue(value); }
        }

        private readonly SV<int> _gold;
        public int Gold
        {
            get { return _gold.GetValue(); }
            set { _gold.SetValue(value); }
        }
        ...
        private readonly SV<int> _credits;
            ...
            protected override void ImportStats(StatsType stats, object val)
            {
                ...
                case StatsType.Diamond: Diamond = (int)val; break;
                case StatsType.Iron: Iron = (int)val; break;
                case StatsType.Gold: Gold = (int)val; break;
                case StatsType.Credits: Credits = (int)val; break;
                    ...
                    //case StatsType.Gems: Gems = (int)val; break;
                    //case StatsType.CurrentGems: CurrentGems = (int)val; break;
                }
            }
            ...
            stats[StatsType.Diamond] = Diamond;
            stats[StatsType.Iron] = Iron;
            stats[StatsType.Gold] = Gold;
            stats[StatsType.Credits] = Credits;
                ...
                //stats[StatsType.MaxTactician] = Stats[11];
                ...
                //stats[StatsType.MaxTacticianBonus] = Stats.Boost[11];
                ...
                //stats[StatsType.Gems] = Gems;
                //stats[StatsType.CurrentGems] = CurrentGems;
            }
            ...
            _diamond = new SV<int>(this, StatsType.Diamond, client.Account.Diamonds, true);
            _iron = new SV<int>(this, StatsType.Iron, client.Account.Iron, true);
            _gold = new SV<int>(this, StatsType.Gold, client.Account.Gold, true);
            _credits = new SV<int>(this, StatsType.Credits, client.Account.Credits, true);
                ...
                //_gems = new SV<int>(this, StatsType.Gems, client.Account.Gems, true);
                //_currentGems = new SV<int>(this, StatsType.CurrentGems, client.Account.Gems, true);
            ...
            private void AnnounceDeath(string killer)
            {
                ...
                var maxed = playerDesc.Stats.Where((t, i) => Stats.Base[i] >= t.MaxValue).Count();
                var deathMessage = 
                    "<" + Name + "> died to " + killer + " at level " + Level + " as " + playerDesc.ObjectId + ", had " + Fame + " Base Fame" + " and was " + maxed + "/8"
                    ;
