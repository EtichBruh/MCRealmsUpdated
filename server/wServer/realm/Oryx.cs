...
namespace wServer.realm
{
    ...
    class Oryx
    {
        ...
        private static readonly Tuple<string, TauntData>[] CriticalEnemies = new Tuple<string, TauntData>[]
        {
            ...
            {
                Spawn = new string[] {
                    "My Queen of Hearts will certainly shatter your heart!"
                },
                Killed = new string[] {
                    "The Queen has fallen! Minions, to arms!",
                    "{PLAYER} Shall certainly be killed! Come on!"
                }
            }),
            */
            //
        ...
        public void OnPlayerEntered(Player player)
        {
            ...
            player.SendInfo("Type \"/mscale (number)\" to change the map scale");
        ...
        private void CloseRealm()
        {
            ...
            _world.Timers.Add(new WorldTimer(30000, (w, t) => SendToCastle()));
        }
