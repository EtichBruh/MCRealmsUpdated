...
namespace wServer.logic.behaviors
{
    class Shoot : CycleBehavior
    {
        ...
        private readonly float _projectileOffsetX;
        private readonly float _projectileOffsetY;
            ...
            )
        {
            ...
            _projectileOffsetX = (float) projectileOffsetX;
            _projectileOffsetY = (float) projectileOffsetY;
        }
        ...
        protected override void TickCore(Entity host, RealmTime time, ref object state)
        {
            ...
            if (cool <= 0)
            {
                ...
                if (player != null || _defaultAngle != null || _fixedAngle != null)
                {
                    ...
                    if (_projectileOffsetX != 0 | _projectileOffsetY != 0) {
                        prjPos = new Position() { X = host.X + _projectileOffsetX, Y = host.Y + _projectileOffsetY };
                    }
