...
public class CreditDisplay extends Sprite {
    ...
    private var goldText_:TextFieldDisplayConcrete;
    private var ironText_:TextFieldDisplayConcrete;
    private var diamondText_:TextFieldDisplayConcrete;
    ...
    private var goldIcon_:Bitmap;
    private var ironIcon_:Bitmap;
    private var diamondIcon_:Bitmap;
    private var coinIcon_:Bitmap;
    private var fameIcon_:Bitmap;
    private var fortuneIcon_:Bitmap;
    private var gold_:int = -1;
    private var iron_:int = -1;
    private var diamond_:int = -1;
    ...
    //private var GemsText:TextFieldDisplayConcrete;
    //private var GemsIcon:Bitmap;
    //private var Gems_:int = -1;
    ...
    public function CreditDisplay(_arg1:GameSprite = null, _arg2:Boolean = true, _arg3:Boolean = false, _arg4:Number = 0) {
        ...
        /*this.diamondText_ = this.makeTextField();
        waiter.push(this.diamondText_.textChanged);
        addChild(this.diamondText_);
        this.diamondIcon_ = new Bitmap(IconFactory.makeDiamond());
        addChild(this.diamondIcon_);

        this.ironText_ = this.makeTextField();
        waiter.push(this.ironText_.textChanged);
        addChild(this.ironText_);
        this.ironIcon_ = new Bitmap(IconFactory.makeIron());
        addChild(this.ironIcon_);

        this.goldText_ = this.makeTextField();
        waiter.push(this.goldText_.textChanged);
        addChild(this.goldText_);
        this.goldIcon_ = new Bitmap(IconFactory.makeGold());
        addChild(this.goldIcon_);*/
    ...
    private function onAlignHorizontal():void {
        ...
        /*this.diamondIcon_.x = (this.coinIcon_.x + 10);
        this.diamondIcon_.y = (this.coinIcon_.y + 30);
        this.diamondText_.x = ((this.diamondIcon_.x - this.diamondText_.width) - 2);
        this.diamondText_.y = ((this.diamondIcon_.y + (this.diamondIcon_.height / 2)) - (this.diamondText_.height / 2));

        this.ironIcon_.x = ((this.creditsText_.x - this.fameIcon_.width) + 10);
        this.ironIcon_.y = (this.diamondIcon_.y);
        this.ironText_.x = ((this.ironIcon_.x - this.ironText_.width) - 2);
        this.ironText_.y = ((this.ironIcon_.y + (this.ironIcon_.height / 2)) - (this.ironText_.height / 2));

        this.goldIcon_.x = (this.coinIcon_.x + 10);
        this.goldIcon_.y = (this.diamondIcon_.y + 25);
        this.goldText_.x = ((this.goldIcon_.x - this.goldText_.width) - 2);
        this.goldText_.y = ((this.goldIcon_.y + (this.goldIcon_.height / 2)) - (this.goldText_.height / 2));*/
    ...
    public function draw(_arg1:int, _arg2:int, _arg3:int = 0, _arg4:int = 0, _arg5:int = 0, _arg6:int = 0, _arg7:int = 0):void {
        if (this.displayFortune_) {
            this.handleFortuneTimeTextUpdate();
        }
        if ((((((_arg1 == this.credits_)) && (((this.displayFame_) && ((_arg2 == this.fame_)))))) && (((this.displayFortune_) && ((_arg3 == this.fortune_) && (((_arg5 == this.diamond_) && (((_arg6 == this.iron_) && (((_arg7 == this.gold_)))))))))))) {
            return;
        }
        this.credits_ = _arg1;
        this.diamond_ = _arg5;
        ...
        /*this.diamondText_.setStringBuilder(new StaticStringBuilder(this.diamond_.toString()));
        this.ironText_.setStringBuilder(new StaticStringBuilder(this.iron_.toString()));
        this.goldText_.setStringBuilder(new StaticStringBuilder(this.gold_.toString()));*/
        ...
        //this.Gems_ = _arg4;
        //this.GemsText.setStringBuilder(new StaticStringBuilder(this.Gems_.toString()));
        if (waiter.isEmpty()) {
            this.onAlignHorizontal();
        }
    }
