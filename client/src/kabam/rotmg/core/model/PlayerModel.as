...
public class PlayerModel {
    ...
    public const diamondsChanged:Signal = new Signal(int);
    public const ironChanged:Signal = new Signal(int);
    public const goldChanged:Signal = new Signal(int);
    ...
    public const GemsChanged:Signal = new Signal(int);
    ...
    public function changeDiamonds(_arg1:int):void {
        this.charList.diamonds_ = (this.charList.diamonds_ + _arg1);
        this.diamondsChanged.dispatch(this.charList.diamonds_);
    }

    public function setDiamonds(_arg1:int):void {
        if (this.charList.diamonds_ != _arg1) {
            this.charList.diamonds_ = _arg1;
            this.diamondsChanged.dispatch(_arg1);
        }
    }

    public function changeIron(_arg1:int):void {
        this.charList.iron_ = (this.charList.iron_ + _arg1);
        this.ironChanged.dispatch(this.charList.iron_);
    }

    public function setIron(_arg1:int):void {
        if (this.charList.iron_ != _arg1) {
            this.charList.iron_ = _arg1;
            this.ironChanged.dispatch(_arg1);
        }
    }

    public function changeGold(_arg1:int):void {
        this.charList.gold_ = (this.charList.gold_ + _arg1);
        this.goldChanged.dispatch(this.charList.gold_);
    }

    public function setGold(_arg1:int):void {
        if (this.charList.gold_ != _arg1) {
            this.charList.gold_ = _arg1;
            this.goldChanged.dispatch(_arg1);
        }
    }
    ...
    //public function updateGems():int {
    //    return (this.charList.Gems_);
    //}

    //public function setGems(_arg1:int):void {
    //    if (this.charList.Gems_ != _arg1) {
    //        this.charList.Gems_ = _arg1;
     //       this.GemsChanged.dispatch(_arg1);
    //    }
    //}
}
}
