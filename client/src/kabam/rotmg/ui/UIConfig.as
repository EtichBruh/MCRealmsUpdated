...
import kabam.rotmg.Forge.ForgeUIMediator;
...
import kabam.rotmg.Forge.components.ForgePanelMediator;
import kabam.rotmg.startup.control.StartupSequence;
import kabam.rotmg.ui.commands.ChooseNameCommand;
import kabam.rotmg.ui.commands.EndRaidCommand;
...
public class UIConfig implements IConfig {
    ...
    public function configure():void {
        ...
        this.mediatorMap.map(ForgePanel).toMediator(ForgePanelMediator);
        this.mediatorMap.map(ForgeUI).toMediator(ForgeUIMediator);
        this.mediatorMap.map(EndRaidSignal).toMediator(EndRaidCommand);
        this.setupKeyUI();
