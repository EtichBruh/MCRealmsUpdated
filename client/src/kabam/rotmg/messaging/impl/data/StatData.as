...
public class StatData {
    ...
    public static const DIAMONDS_STAT:int = 106;
    public static const IRON_STAT:int = 107;
    public static const GOLD_STAT:int = 108;


    //public static const GEMS_STAT:int = 107;
    ...
    public static function statToName(_arg1:int):String {
        switch (_arg1) {
            ...
            //case MAXTACTICIAN:
            //    return ("Max TC");
            //case MAXTACTICIAN_STAT:
            //    return ("Tactician Points");
        }
