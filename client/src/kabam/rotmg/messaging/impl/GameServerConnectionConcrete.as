...
import kabam.rotmg.messaging.impl.incoming.LootPopUp;
...
import kabam.rotmg.ui.signals.EndRaidSignal;
import kabam.rotmg.ui.signals.ShowHideKeyUISignal;
import kabam.rotmg.ui.signals.ShowKeySignal;
import kabam.rotmg.ui.signals.UpdateBackpackTabSignal;
import kabam.rotmg.ui.view.NotEnoughGoldDialog;
import kabam.rotmg.ui.view.TitleView;
import kabam.rotmg.ui.view.allahRaid;
import kabam.rotmg.ui.view.endRaid;
import kabam.rotmg.ui.view.flashBang;
import kabam.rotmg.ui.view.nwordpass;
import kabam.rotmg.ui.view.santaRaid;
import kabam.rotmg.ui.view.thanosRaid;
import kabam.rotmg.ui.view.viktor;
import kabam.rotmg.ui.view.witherStormRaid;
...
public class GameServerConnectionConcrete extends GameServerConnection {
    ...
    public function mapMessages():void {
        ...
        _local1.map(LOOT_POP_UP).toMessage(LootPopUp).toMethod(this.onLoot);
        _local1.map(FORGEITEM).toMessage(ForgeItem);
    }

    public function onLoot() : void
    {
        SoundEffectLibrary.play("legendary");
    }
    ...
    private function onGlobalNotification(_arg1:GlobalNotification):void {
        var _loc1:endRaid = null;
        var _loc2:allahRaid = null;
        var _loc3:witherStormRaid = null;
        var _loc4:thanosRaid = null;
        var _loc5:flashBang = null;
        var _loc6:santaRaid = null;
        var _loc7:viktor = null;
        var _loc8:nwordpass = null;
        ...
        switch (_arg1.text) {
            ...
            case "enderRoar":
                ...
                _loc1.scaleX = 0.2;
                _loc1.scaleY = 0.2;
                SoundEffectLibrary.play("enderRoar");
                new GTween(_loc1,1.5,{
                    "alpha":1,
                    "scaleX":1,
                    "scaleY":1
                },{
            ...
            case "allah":
                ...
                _loc2.scaleX = 0.2;
                _loc2.scaleY = 0.2;
                SoundEffectLibrary.play("allah");
                new GTween(_loc2,1.5,{
                    "alpha":1,
                    "scaleX":1,
                    "scaleY":1
                },{
                ...
                return;
            case "witherStorm":
                _loc3 = new witherStormRaid();
                _loc3.x = 0;
                _loc3.y = 0;
                _loc3.scaleX = 0.2;
                _loc3.scaleY = 0.2;
                SoundEffectLibrary.play("enderRoar");
                new GTween(_loc3,1.5,{
                    "alpha":1,
                    "scaleX":1,
                    "scaleY":1
                },{
                ...
                return;
            case "thanosRaid":
                _loc4 = new thanosRaid();
                _loc4.x = 0;
                _loc4.y = 0;
                _loc4.scaleX = 0.2;
                _loc4.scaleY = 0.2;
                SoundEffectLibrary.play("thanos");
                new GTween(_loc4,1.5,{
                    "alpha":1,
                    "scaleX":1,
                    "scaleY":1
                },{
            ...
            case "flashBang":
                ...
                _loc5.scaleX = 0.2;
                _loc5.scaleY = 0.2;
                SoundEffectLibrary.play("flashBang");
                new GTween(_loc5,0.5,{
                    "alpha":1,
                    "scaleX":2,
                    "scaleY":2
                },{
            ...
            case "santaRaid":
                ...
                _loc6.scaleX = 0.2;
                _loc6.scaleY = 0.2;
                SoundEffectLibrary.play("hoho");
                new GTween(_loc6,1.5,{
                    "alpha":1,
                    "scaleX":1,
                    "scaleY":1
                },{
    ...
    private function onShowEffect(_arg1:ShowEffect):void {
        ...
        if (Parameters.data_.noParticlesMaster
                && (_arg1.effectType_ == ShowEffect.HEAL_EFFECT_TYPE
                        || _arg1.effectType_ == ShowEffect.TELEPORT_EFFECT_TYPE
                        || _arg1.effectType_ == ShowEffect.STREAM_EFFECT_TYPE
                        || _arg1.effectType_ == ShowEffect.POISON_EFFECT_TYPE
                        || _arg1.effectType_ == ShowEffect.LINE_EFFECT_TYPE
                        || _arg1.effectType_ == ShowEffect.FLOW_EFFECT_TYPE
                        || _arg1.effectType_ == ShowEffect.COLLAPSE_EFFECT_TYPE
                        || _arg1.effectType_ == ShowEffect.CONEBLAST_EFFECT_TYPE)) {
            return;
        }
        ...
        for each (_local7 in _arg2) {
            ...
            switch (_local7.statType_) {
                ...
                case StatData.WISDOM_STAT:
                    ...
                    break;
                //case StatData.MAXTACTICIAN_STAT:
                //    _local4.maxMP_ = _local8;
                //    break;
                //case StatData.MAXTACTICIAN:
                //    _local4.mp_ = _local8;
                //    break;
                ...
                case StatData.TEXTURE_STAT:
                    ...
                    break;
                case StatData.DIAMONDS_STAT:
                    _local4.setDiamond(_local8);
                    break;
                case StatData.IRON_STAT:
                    _local4.setIron(_local8);
                    break;
                case StatData.GOLD_STAT:
                    _local4.setGold(_local8);
                    break;
                //case StatData.GEMS_STAT:
                //    player.setGems(_local8);
                //    break;
