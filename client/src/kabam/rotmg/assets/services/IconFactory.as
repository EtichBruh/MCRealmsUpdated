...
public class IconFactory {
    ...
    public static function makeGold(_arg1:int = 40):BitmapData {
        var _local2:BitmapData = TextureRedrawer.resize(AssetLibrary.getImageFromSet("lofiObj3", 228), null, _arg1, true, 0, 0);
        return (cropAndGlowIcon(_local2));
    }
    public static function makeIron(_arg1:int = 40):BitmapData {
        var _local2:BitmapData = TextureRedrawer.resize(AssetLibrary.getImageFromSet("lofiObj3", 227), null, _arg1, true, 0, 0);
        return (cropAndGlowIcon(_local2));
    }

    public static function makeDiamond(_arg1:int = 40):BitmapData {
        var _local2:BitmapData = TextureRedrawer.resize(AssetLibrary.getImageFromSet("lofiObj3", 229), null, _arg1, true, 0, 0);
        return (cropAndGlowIcon(_local2));
    }

    public static function makeCoin(_arg1:int = 40):BitmapData {
        var _local2:BitmapData = TextureRedrawer.resize(AssetLibrary.getImageFromSet("lofiObj3", 230), null, _arg1, true, 0, 0);
        return (cropAndGlowIcon(_local2));
    }
    ...
    //public static function makeGems():BitmapData {
    //    var _local1:BitmapData = TextureRedrawer.resize(AssetLibrary.getImageFromSet("lofiObj3", 0x5a5), null, 40, true, 0, 0);
    //    return (cropAndGlowIcon(_local1));
    //}
