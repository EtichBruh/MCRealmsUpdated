...
public class Options extends Sprite {
    ...
    private function addExperimentalOptions():void {
        ...
        this.addOptionAndPosition(new ChoiceOption("disableQuestNotifications", makeOnOffLabels(), [true,false], "Disable Quest Notifications", "Disable the notifications given when a quest is completed.", null));
    }
    ...
    private function addGraphicsOptions():void {
        ...
        this.addOptionAndPosition(new ChoiceOption("stageScale", makeOnOffLabels(), [StageScaleMode.NO_SCALE, StageScaleMode.EXACT_FIT], "Fullscreen", "Extends viewing area at a cost of lower FPS.", this.fsv3, 840583)); //840583 (decide on usage)
        this.addOptionAndPosition(new ChoiceOption("uiscale", makeOnOffLabels(), [true, false], "UI Scale", "Scales equipment UI.", null, 840583)); //840583 (decide on usage)
