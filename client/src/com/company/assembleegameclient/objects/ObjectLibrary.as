...
public class ObjectLibrary {
        ...
        for each (_local3 in _arg1.Object) {
            ...
            if (((_local3.hasOwnProperty("PetBehavior")) || (_local3.hasOwnProperty("PetAbility")))) {
                ...
                if (_local3.hasOwnProperty("Animation")) {
                    ...
                    {
                        dungeonToPortalTextureData_[String(_local3.DungeonName)] = typeToTextureData_[_local3];
                    }
                }
            }
        }
    ...
    public static function getRedrawnTextureFromType(_arg1:int, _arg2:int, _arg3:Boolean, _arg4:Boolean = true, _arg5:Number = 5) : BitmapData
    {
        ...
        if(Parameters.itemTypes16.indexOf(_arg1) != -1 || _local6.height == 15)
        {
            _arg2 = _arg2 * 0.5333;
        }
        if(Parameters.itemTypes16.indexOf(_arg1) != -1 || _local6.height == 14)
        {
            _arg2 = _arg2 * 0.5714;
        }
        if(Parameters.itemTypes16.indexOf(_arg1) != -1 || _local6.height == 13)
        {
            _arg2 = _arg2 * 0.6153;
        }
        //
        if(Parameters.itemTypes16.indexOf(_arg1) != -1 || _local6.height == 12)
        {
            _arg2 = _arg2 * 0.75;
        }
        //for all type of stuffs
        if(Parameters.itemTypes16.indexOf(_arg1) != -1 || _local6.height == 11)
        {
            _arg2 = _arg2 * 0.7272;
        }
        if(Parameters.itemTypes16.indexOf(_arg1) != -1 || _local6.height == 10)
        {
            _arg2 = _arg2 * 0.80;
        }
        if(Parameters.itemTypes16.indexOf(_arg1) != -1 || _local6.height == 9)
        {
            _arg2 = _arg2 * 0.8888;
        }
        ...
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0xFFFF00,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("MC"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0x17d1d4,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("END"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0x6a0dad,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("@special"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0x249eff,_arg4,_arg5);
        }

        if(_local8 == null && _local9.hasOwnProperty("@unholylg"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,0x6F28CC,_arg4,_arg5);
        }
