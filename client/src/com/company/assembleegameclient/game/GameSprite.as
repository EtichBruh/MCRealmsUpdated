...
public class GameSprite extends AGameSprite {
    ...
    override public function initialize():void {
        ...
        if (map.name_ == Map.NEXUS) {
            //Beginners package and Daily Login
            /*
    ...
    private function onEnterFrame(_arg1:Event):void {
        ...
        if (_local5 != null) {
            this.creditDisplay_.draw(_local5.credits_, _local5.fame_, _local5.tokens_, 0, _local5.diamond_, _local5.iron_, _local5.gold_);
