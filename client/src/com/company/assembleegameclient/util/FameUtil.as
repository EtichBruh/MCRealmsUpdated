...
public class FameUtil {
    ...
    public static function getGoldIcon():BitmapData {
        var _local1:BitmapData = AssetLibrary.getImageFromSet("lofiObj3", 228);
        return (TextureRedrawer.redraw(_local1, 40, true, 0));
    }

    public static function getIronIcon():BitmapData {
        var _local1:BitmapData = AssetLibrary.getImageFromSet("lofiObj3", 227);
        return (TextureRedrawer.redraw(_local1, 40, true, 0));
    }

    public static function getDiamondIcon():BitmapData {
        var _local1:BitmapData = AssetLibrary.getImageFromSet("lofiObj3", 229);
        return (TextureRedrawer.redraw(_local1, 40, true, 0));
    }
