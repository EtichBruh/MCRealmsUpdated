...
public class AssetLoader {
    ...
    private function addImages():void {
	    AssetLibrary.addImageSet("MCbosses64x64", new EmbeddedAssets.MCbosses64x64().bitmapData, 64, 64);
        AssetLibrary.addImageSet("craftSlot", new EmbeddedAssets.craftSlot().bitmapData, 18, 19);
        ...
        AssetLibrary.addImageSet("lofiItems16x16", new EmbeddedAssets.lofiItems16x16Embed_().bitmapData, 16, 16);
	AssetLibrary.addImageSet("heatblastsucks", new EmbeddedAssets.heatblastsucks().bitmapData, 8, 8);
    ...
    private function addAnimatedCharacters():void {
        ...
        AnimatedChars.add("crewmate", new EmbeddedAssets.CrewmateEmbed_().bitmapData, null, 9, 9, 63, 27, AnimatedChar.RIGHT);
    ...
    private function addSoundEffects():void {
        ...
        SoundEffectLibrary.load("enderRoar");
        SoundEffectLibrary.load("allah");
        SoundEffectLibrary.load("viktor");
        SoundEffectLibrary.load("thanos");
        SoundEffectLibrary.load("flashBang")
        SoundEffectLibrary.load("hoho");
    }
